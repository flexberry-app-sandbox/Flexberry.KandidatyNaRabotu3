...
moduleForModel('i-i-s-kandidaty-na-rabotu-сотрудники', 'Unit | Serializer | i-i-s-kandidaty-na-rabotu-сотрудники', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-kandidaty-na-rabotu-сотрудники',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
