...
moduleForModel('i-i-s-kandidaty-na-rabotu-регист-анкеты', 'Unit | Serializer | i-i-s-kandidaty-na-rabotu-регист-анкеты', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-kandidaty-na-rabotu-регист-анкеты',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
