...
namespace IIS.Kandidaty_na_rabotu
{
    ...
    [View("РегистАнкетыE", new string[] {
            "ДатаРегистр as \'Дата регистрации анкеты\'",
            "ФИОКандид as \'ФИО кандидата\'",
            ...
            "Организация.Наименование as \'Наименование организации\'"}, Hidden=new string[] {
    ...
    public class РегистАнкеты : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Kandidaty_na_rabotu.ВакантДолжн fВакантДолжн;
        ...
        [PropertyStorage(new string[] {
                "ВакантДолжн"})]
        [NotNull()]
        public virtual IIS.Kandidaty_na_rabotu.ВакантДолжн ВакантДолжн
        {
            get
            {
                ...
                IIS.Kandidaty_na_rabotu.ВакантДолжн result = this.fВакантДолжн;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РегистАнкетыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РегистАнкетыE", typeof(IIS.Kandidaty_na_rabotu.РегистАнкеты));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РегистАнкетыL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РегистАнкетыL", typeof(IIS.Kandidaty_na_rabotu.РегистАнкеты));
                }
            }
        }
    }
