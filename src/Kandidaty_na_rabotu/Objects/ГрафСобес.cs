...
namespace IIS.Kandidaty_na_rabotu
{
    ...
    [AssociatedDetailViewAttribute("ГрафСобесE", "ТЧГрафСобес", "ТЧГрафСобесE", true, "", "График собеседований кандидатов", true, new string[] {
            ""})]
    [View("ГрафСобесL", new string[0])]
    public class ГрафСобес : ICSSoft.STORMNET.DataObject
    {
        
        private IIS.Kandidaty_na_rabotu.DetailArrayOfТЧГрафСобес fТЧГрафСобес;
        ...
        public virtual IIS.Kandidaty_na_rabotu.DetailArrayOfТЧГрафСобес ТЧГрафСобес
        {
            get
            {
                ...
                {
                    this.fТЧГрафСобес = new IIS.Kandidaty_na_rabotu.DetailArrayOfТЧГрафСобес(this);
                }
                IIS.Kandidaty_na_rabotu.DetailArrayOfТЧГрафСобес result = this.fТЧГрафСобес;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ГрафСобесE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ГрафСобесE", typeof(IIS.Kandidaty_na_rabotu.ГрафСобес));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ГрафСобесL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ГрафСобесL", typeof(IIS.Kandidaty_na_rabotu.ГрафСобес));
                }
            }
        }
    }
