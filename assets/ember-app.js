...
define('ember-app/mixins/regenerated/models/i-i-s-kandidaty-na-rabotu-\u043F\u043B\u0430\u043D\u0438\u0440-\u0441\u043E\u0431\u0435\u0441', ['exports', 'ember-data', 'ember-cp-validations', 'ember-flexberry-data/utils/attributes'], function (exports, _emberData, _emberCpValidations, _attributes) {
  ...
  var defineProjections = exports.defineProjections = function defineProjections(modelClass) {
    modelClass.defineProjection('ПланирСобесE', 'i-i-s-kandidaty-na-rabotu-планир-собес', {
      ...
      кабинет: (0, _attributes.attr)('Номер кабинета проведения собеседования', { index: 1 }),
      этаж: (0, _attributes.attr)('Этаж', { index: 2 }),
      время: (0, _attributes.attr)('Время собеседования', { index: 3 }),
      регистАнкеты: (0, _attributes.belongsTo)('i-i-s-kandidaty-na-rabotu-регист-анкеты', 'ФИО кандидата', {
        фИОКандид: (0, _attributes.attr)('ФИО кандидата', { index: 5, hidden: true }),
        вакантДолжн: (0, _attributes.belongsTo)('i-i-s-kandidaty-na-rabotu-вакант-должн', '', {
          должность: (0, _attributes.attr)('Вакантная должность', { index: 6 })
        }, { index: -1, hidden: true }),
        номерТелефона: (0, _attributes.attr)('Номер телефона кандидата', { index: 8 }),
        элПочта: (0, _attributes.attr)('Электронная почта', { index: 9 }),
        организация: (0, _attributes.belongsTo)('i-i-s-kandidaty-na-rabotu-организация', '', {
          адрес: (0, _attributes.attr)('Адрес организации', { index: 12 }),
          телОрганиз: (0, _attributes.attr)('Телефон организации', { index: 13 })
        }, { index: -1, hidden: true })
      }, { index: 4, displayMemberPath: 'фИОКандид' }),
      иметьПриСебе: (0, _attributes.attr)('Иметь при себе', { index: 7 }),
      организация: (0, _attributes.belongsTo)('i-i-s-kandidaty-na-rabotu-организация', 'Наименование организации', {
        наименование: (0, _attributes.attr)('Наименование организации', { index: 11, hidden: true })
    ...
    modelClass.defineProjection('ПланирСобесL', 'i-i-s-kandidaty-na-rabotu-планир-собес', {
      ...
      кабинет: (0, _attributes.attr)('Номер кабинета проведения собеседования', { index: 2 }),
      этаж: (0, _attributes.attr)('Этаж', { index: 3 }),
      регистАнкеты: (0, _attributes.belongsTo)('i-i-s-kandidaty-na-rabotu-регист-анкеты', 'ФИО кандидата', {
        фИОКандид: (0, _attributes.attr)('ФИО кандидата', { index: 4 }),
        вакантДолжн: (0, _attributes.belongsTo)('i-i-s-kandidaty-na-rabotu-вакант-должн', '', {
          должность: (0, _attributes.attr)('Вакантная должность', { index: 5 })
        }, { index: -1, hidden: true }),
        номерТелефона: (0, _attributes.attr)('Номер телефона кандидата', { index: 7 }),
        элПочта: (0, _attributes.attr)('Электронная почта', { index: 8 }),
        организация: (0, _attributes.belongsTo)('i-i-s-kandidaty-na-rabotu-организация', '', {
      ...
      организация: (0, _attributes.belongsTo)('i-i-s-kandidaty-na-rabotu-организация', 'Наименование организации', {
        наименование: (0, _attributes.attr)('Наименование организации', { index: 9 })
      }, { index: -1, hidden: true })
    });
  };
});
  ...
  exports.default = _offlineGlobals.default.extend({
    ...
    getOfflineSchema: function getOfflineSchema() {
      ...
      var returnedSchema = Ember.merge(parentSchema, {
        ...
        'i-i-s-kandidaty-na-rabotu-планир-собес': 'id,время,датаПланСобес,иметьПриСебе,кабинет,этаж,организация,регистАнкеты',
